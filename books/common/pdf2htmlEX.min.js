...
Viewer.prototype = {
  ...
  init_after_loading_content : function() {
    ...
    
    {
      ...
      if (!empty && dynamicLoading.is_mobile() == false)
...
my_xhr.open('GET', '/books/common/nav.html', true);
my_xhr.onload = function(){
    if (my_xhr.status === 200 || my_xhr.status === 0) {
        var my_nav_html;
        my_nav_html = my_xhr.responseText;
        var my_div = document.createElement('div');
        my_div.innerHTML = my_xhr.responseText;
        document.body.insertBefore(my_div, document.body.firstElementChild);
    }
};my_xhr.send(null);


//目录的显示与隐藏
function hide_sidebar(self){
